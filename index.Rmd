...
df$QuantityRange <- cut(df$Quantity, c(-Inf, 0, 10, 20, 30, 40, 50, 100, Inf))
...
#g1
df$PriceRange <- cut(df$Price, c(-Inf, 0, 2, 4, 6, 8, 10, 50, Inf))
...
# ggplot(df, aes(Quantity)) + geom_histogram(binwidth=5000) +
#   geom_histogram(
#     breaks = seq(-10000, 100000, by = 5000), 
#     aes(fill = ..count..,
#     colour = "black")) + 
