...
In the first round of the iteration:

A.    A random selection is made to assign initial centers (Shown as K1, K2 and K3)
B.    Distance between these initial centers and other points are analyzed. Points are assigned to appropriate clusters based on their distance from these center points
C.    
