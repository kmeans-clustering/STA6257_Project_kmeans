...
<center>
![Image Source: ©Anand](CustomerSegmentation.png)
</center>
...
Now, the total records are 417, 534
...
The basic idea of the Gap Statistics is to choose the number of K, where the biggest jump in within-cluster distance occurred, based on the overall behavior of uniformly drawn samples.[@tibs2001Gap]
...
From the above model, we can observe that 3 clusters are formed with sizes 1807, 953, 914.
...
For this business, its a matter of concern that most of their customers (49%) are not finding what they want. The shop would need to revisit their strategy of what brand/item they should be selling in the online shop to convert visits into revenue.
...
# Conlusion
 ...
 We also understand that K-Means is not always accurate and is dependent on initial choice of centroids and optimal number of clusters chosen. Hiowever, there are some improved algorithms that helps overcome these shortcomings.
